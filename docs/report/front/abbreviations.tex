...
\begin{description}
    ...
    \item \textbf{AES} - Automated Essay Scoring
    \item \textbf{AI} - Artificial Intelligence
    \item \textbf{API} - Application Programming Interface
    \item \textbf{ASAG} - Automated Short Answer Grading
    ...
    \item \textbf{IOPS} - Intelligent Online Proctoring System
    ...
    \item \textbf{QWK} - Quadratic Weighted Kappa
    ...
    \item \textbf{TOEFL} - Test of English as a Foreign Language

...
\begin{itemize}
    ...
    \item \textbf{Integrate local digital services:} The platform should be extended to work with relevant Ethiopian digital ecosystems, including local payment providers, institutional identity systems, and national or enterprise-level verification services where appropriate.

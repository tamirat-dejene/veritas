...
Offloading high-latency operations to Kafka was critical for platform reliability. Workflows like sending SMTP onboarding emails, rendering certificates, recomputing multi-variable cheating risk, and running AI models are asynchronous by design. Rationale for offloading these workloads includes:
\begin{itemize}

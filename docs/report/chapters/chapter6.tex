...
This section summarizes the measured performance of the Veritas semantic grading engine after model tuning and structural scoring fixes. The evaluation targets short-answer grading and reports the final production metrics and structural interventions. The deployed configuration uses a DeBERTa-v3-small cross-encoder with a T5-base paraphrase lane in a hybrid fusion pipeline. Inference is CPU-only with a measured throughput of approximately 2.0 seconds per answer under batching.

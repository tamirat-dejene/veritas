...
The general objective of the project is to design and develop an AI-enhanced online assessment and monitoring system.
...
\begin{itemize}
    ...
    \item To design and generate organization-specific certificates that are automatically issued to examinees upon successful completion. 
...
\begin{enumerate}[leftmargin=*,label=\textbf{\arabic*.}]
    ...
    Core coding phase, updated to include facial recognition, personalized feedback, and certificate generation in iterative sprints.
    \begin{itemize}[leftmargin=1.6em]
        \item Activities:
        \begin{itemize}[leftmargin=1.4em]
        ...
        \item Deliverables: Code repository; API documentation; prototype demo; interim report on new features like certificate automation.
    \end{itemize}

...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_suspend_enterprise.png} 
\\ \hline
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_manage_subscription.png}
\\ \hline
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_view_dashboard.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_register_enterprise.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_login.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_manage_staff.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_create_exam.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_schedule_exam.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_assign_candidates.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_view_dashboard_enterprise.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_generate_report.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_manage_enterprise_subscription.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_manage_exams.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_view_reports.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_register_candidate.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_verify_identity.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_start_exam.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_submit_exam.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_view_results.png}
\\ \hline
\end{tabularx}
...
% ================================================
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}X|}
\caption{Use Case Specification: Receive Certificate}
\label{tab:uc-receive-certificate} \\ \hline

\textbf{Field} & \textbf{Details} \\ \hline
Use Case ID & UC-23 \\ \hline
Use Case Name & Receive Certificate \\ \hline
Primary Actor & Candidate \\ \hline
Secondary Actor(s) & None \\ \hline

Description &
Issues certificate upon successful completion.
\\ \hline
...
Main Flow (Basic Flow) &
1. Candidate qualifies for certificate. \newline
2. System generates certificate. \newline
3. Candidate receives certificate.
\\ \hline
...
Exception Flow(s) &
E1: Not qualified – System notifies of requirements.
\\ \hline

Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_receive_certificate.png}
\\ \hline
\end{tabularx}
...
Use Case Diagram &
\includegraphics[width=0.6\linewidth]{assets/uc_diagrams/uc_process_payment.png}
\\ \hline
\end{tabularx}

...
type QuestionRepository interface {
	...
	GetByID(ctx context.Context, id uuid.UUID, enterpriseID uuid.UUID) (*sdomain.Question, error)
	ListByEnterprise(ctx context.Context, enterpriseID uuid.UUID, params pagination.Params) (pagination.PaginatedResponse[*sdomain.Question], error)
...
type QuestionUsecase interface {
	...
	GetQuestions(ctx context.Context, enterpriseID uuid.UUID, params pagination.Params) (pagination.PaginatedResponse[*sdomain.Question], error)
	GetQuestion(ctx context.Context, id uuid.UUID, enterpriseID uuid.UUID) (*sdomain.Question, error)

...
type ExamRepository interface {
	...
	ListByEnterprise(ctx context.Context, enterpriseID uuid.UUID, params pagination.Params, search string, archived bool) (pagination.PaginatedResponse[*sdomain.Exam], error)
...
type ExamUsecase interface {
	...
	GetExams(ctx context.Context, enterpriseID uuid.UUID, params pagination.Params, search string, archived bool) (pagination.PaginatedResponse[*sdomain.Exam], error)
